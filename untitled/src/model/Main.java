...
public class Main {
    public static void main(String[] args) {
        ...
        p.calcularSalario();
        System.out.println("Seu nome model.Professor(a) é: " + p.nome);
        System.out.println("Sua idade model.Professor(a) é: " + p.idade);
        System.out.println("Seu salario é: " + p.getsalario());
        p.aniversario();
        System.out.println("Seu aniversario:" + p.aniversario());
        pc.cadastrarProfessor(p);
        pc.listarProfessores();


        //--------------------   CADASTRO DISCIPLINA  -------------------- //

        System.out.println("Digite a model.Disciplina: ");
        d.setNomed(sc.next());
        d.associar(p);
        d.mostrarDisciplina();
        System.out.println("model.Professor(a) " + p2.getNome() + " da aula de " + d2.getNomed());
